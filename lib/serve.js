...
Serve.loadSettings = function loadSettings(argv, project) {
  ...
  options.https = options.https || argv.httpscert || argv.httpskey;
  if (argv.httpscert || argv.httpskey) {
    options.https = options.https || {};
    options.https.cert = options.https.cert || argv.httpscert;
    options.https.key = options.https.key || argv.httpskey;
  }
